...
// if (!searchString) {
//   console.error(chalk.red('You must pass a search string'));
//   process.exit(-1);
// }

// let importIdentifier = process.argv[3];
// if (!searchString) {
//   console.error(chalk.red('You must pass the import identifier'));
//   process.exit(-1);
// }
...
try {
  ...
  // Generate EMBER_UNUSED_IMPORT_REPORT.md when jscodeshift is done running.
...
function buildReport() {
  ...
  glob("ember-unused-import-codemod.tmp.*", (err, logs) => {
